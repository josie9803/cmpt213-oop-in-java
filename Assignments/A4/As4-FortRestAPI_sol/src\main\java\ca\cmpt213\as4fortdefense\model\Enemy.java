...
public class Enemy {
    ...
    // Game designed to have points fall off very quickly.
    private final static int[] POINTS_SCORED_PER_DRY_CELLS = {0, 1, 2, 5, 20, 20};
...
//        return count;
    ...
    public int getShotPoints() {
        return POINTS_SCORED_PER_DRY_CELLS[getDryCellCount()];
    }

    public boolean isFortDestroyed() {
        return getDryCellCount() == 0;
    }
}
