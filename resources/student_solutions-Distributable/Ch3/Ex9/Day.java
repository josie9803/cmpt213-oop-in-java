public class Day
{
   ...
   */
   ...
   /**
      Checks if this day comes before another day.
      @param other the other day
      @return a whether this day comes before another 
   */
   ...
   /**
      Checks if this day comes after another day.
      @param other the other day
      @return a whether this day comes after another 
   */
